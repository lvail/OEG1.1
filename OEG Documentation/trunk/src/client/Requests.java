...
/**
 * @author esolares hates white people;
 */
...
public class Requests extends JApplet {
    ...
    private JLabel           oilTextArea, gasTextArea, layerTextArea,
            rockTypeTextArea, mapPane;
    ...
    private void bottomInfo(JPanel panel) {
        ...
        if (Messages.TESTMODE) bottomInfo.add(btnEndRound);
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    if (operator.makeNewDrill(xValue, yValue)) {
                        ...
                        addMessage(
                                "Problem with drill. Make sure the land is owned and there are enough funds.");
                    }
                } catch (NumberFormatException nfe) {
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    if (operator.makeNewBid(xValue, yValue, bidValue)) {
                        ...
                        addMessage(
                                "Invalid Bid. Make sure there are enough funds, or that the minimum bid is met.");
                    }

                } catch (NumberFormatException nfe) {
                    addMessage(
                            "Invalid Bid. Please enter an integer amount in the bid field, or select a cell.");
                }
            }
        });
    }
