...
public class Server extends Thread {
	 ...
	 * @param args String of command line arguments. Unused. */
	 ...
	 * @param window The Manage UI window object.
	 * @param file The XML file selected by Manage and being opened by Director. */
	 ...
	 * socket connections by wrapping them in a new thread and ServerMessages object.
	 * mainDirector is given to this object so that it can add itself to
	...
	private void waitConnections() {
		...
		try {
			...
			System.out
					.println("Server IP address: " + s.getInetAddress());
