...
/** Class to perform "Auctions", that will process all the bids each operator
 * has made during a round and decide the winning bid for each piece of land
 * (or cell) that a bid was placed on.
 */
public class Auction {
	 ...
	 * @param bids An array of queues of bids to be processed. Each array element
	 * is a LinkedList of bids for a particular cell on the Grid.
	 * @param grid The grid from which cells are auctioned off. */
	 ...
	 * @param bid The bid, the comparator of which compares x,y location.
	...
	/** Process the the priorityList that resulted from auction. Notify the winning
	 * bidder of each piece of land that he won, and send the winning bid back to
	 * all losers.
