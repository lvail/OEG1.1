...
/** Superclass that holds similar information
 * for all types of requests that are made in OEG.
 */
public class Action {
	 ...
	 * @param owner The owner responsible for this action.*/
	 ...
	 * @param amount is the setup cost to do survey
	 */
	 ...
	 * @param amount is the additional cost based on length of survey line 
	 */
	 ...
	 * @param amount is the minimum lease bid per grid cell
	 */
	 ...
	 * @return The minimum amount an operator can bid for
	 * a lease on a piece of land.
	 */
	 ...
	 * @param amount  is the cost of drilling in each section.
	 */
	 ...
	 * @param amount is the amount of money PER BARREL.
	 */
	 ...
	 * @param amount is the amount per 1000 cubic feet.
	 */
	 ...
	 * @param in The string holding seismicSetup and seismicRate info.
	 */
	...
	/** Returns a string with the balance after the Action
