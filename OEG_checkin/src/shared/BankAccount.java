...
public class BankAccount {
	...
	/**UnusableFunds are funds that have been allocated to expenses in the current round that have not been processed by the Director, IE drilling or bid requests.  
	 */
	protected int unusableFunds;
	/**Income is the current rate at which the client's bank account by each round.
	 */
	private int income;

	/**
	 * Constructor for the BankAccount Class. Sets the current balance to the starting balance, sets income to 0, and sets unuseableFunds to 0. 
	 */
	public BankAccount()
	{	
	 ...
	 * @param start is passed from the XML parser 
	 */
	...
	/**
	 * returns the balance of the account minus the unuseableFunds, representing the amount that the user has available to use.
	...
	/**Changes the curBalance variable by the amount passed. amount can be positive or negative depending on need.  
	 * @param amount is the amount of funds by which to increase/decrease the bank account
	 */
	 ...
	 * @param amount The amount to set curBalance to.
	 */
	 ...
	 * @param inIncome The amount to set the income to.
	 */
	 ...
	 * @param amount The amount to add to unuseableFunds 
	 */
