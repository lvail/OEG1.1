...
public class LithologicType {
    ...
    private static final String[] abbrNames = { "Grv or Cgl (1)",
                    "Grv or Cgl (2)", "x-bd Grv or Cgl", "", "Brec (1)",
                    "Brec (2)", "Mass Sd. or Sst", "Bd Sd. or Sst",
                    "x-bd Sd. or Sst (1)", "x-bd Sd. or Sst(2)",
                    "Rpl-Bd Sd. or Sst", "arg or sh Sst", "calc Sst", "dol Sst",
                    "", "Slt, Sltst, or sh Slt", "calc Sltst", "dol Sltst",
                    "sdy or slty Sh", "Cl or Cl Sh", "cht Sh", "dol Sh",
                    "calc Sh or marl", "carb Sh", "o Sh", "Chk", "Ls",
                    "clas Ls", "foss clas Ls", "nod or irr Bd Ls",
                    "Ls, irr (Bur?) fillings of sacc Dol", "x-bd Ls",
                    "cht x-bd Ls", "cht and sdy x-bd clas Ls", "ooc Ls",
                    "sdy Ls", "slty Ls", "arg or sh Ls", "cht Ls (1)",
                    "cht Ls (2)", "dol Ls or lmy Dol", "Dolst or Dol",
                    "x-bd Dolst or Dol", "ooc Dolst or Dol", "sdy Dolst or Dol",
                    "slty Dolst or Dol", "arg or sh Dolst or Dol",
                    "cht Dolst or Dol", "Bd Cht (1)", "Bd Cht (2)",
                    "foss Bd Cht", "foss Rk", "Diatomaceous Rk", "Sbgwke",
                    "x-bd Sbgwke", "Rpl-Bd Sbgwke", "Peat", "C",
                    "Bony C or impure C", "Uc", "Flint Cl", "Bent", "Blauc",
                    "Lim", "Sid.", "phos-nod Rk", "Gyp", "Sa",
                    "intbd Sst and Sltst", "intbd Sst and Sh",
                    "intbd RplBd Sst and Sh", "intbd Sh and slty Ls (Sh dom)",
                    "intbd Sh and Ls (Sh dom) (1)",
                    "intbd Sh and Ls (Sh dom) (2)",
                    ...
                    "Till or diamicton (3)", "Loess (1)", "Loess (2)",
                    "Loess (3)", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "Meta", "Qtzt.", "Sl.", "sch or gns Grt", "Sch.",
                    "cntrt Sch.", "Sch. and Gns", "Gns", "cntrt Gns",
                    "Soapstone, talc, or serpentinite", "tf Rk", "Xl Tf",
                    "devit Tf", "volc Brec and Tf", "volc Brec or Aglm",
                    "Zeolitic Rk", "bas flows", "Grt (1)", "Grt (2)", "bnd Ig",
                    "Ig (1)", "Ig (2)", "Ig (3)", "Ig (4)", "Ig (5)", "Ig (6)",
                    "Ig (7)", "Ig (8)", "Porphyritic Rk (1)",
                    "Porphyritic Rk (2)", "Vit", "Qtz.", "Ore" };
    private static final String[] fullNames = {
                    ...
                    "Breccia (1st option)", "Breccia (2nd option)",
                    "Massive sand or sandstone", "Bedded sand or sandstone",
                    ...
                    "Sandy or silty shale", "Clay or clay shale",
                    "Cherty shale", "Dolomitic shale",
                    "Calcareous shale or marl", "Carbonaceous shale",
                    ...
                    "Crossbedded subgraywacke", "Ripple-bedded subgraywacke",
                    "Peat", "Coal", "Bony coal or impure coal", "Underclay",
                    "Flint clay", "Bentonite", "Glauconite", "Limonite",
                    "Siderite", "Phosphatic-nodular rock", "Gypsum", "Salt",
                    ...
                    "", "", "", "", "", "", "", "", "", "", "Metamorphism",
                    "Quartzite", "Slate", "Schistose or gneissoid granite",
                    "Schist", "Contorted schist", "Schist and gneiss", "Gneiss",
                    "Contorted gneiss", "Soapstone, talc, or serpentinite",
                    "Tuffaceous rock", "Crystal tuff", "Devitrified tuff",
                    "Volcanic breccia and tuff",
                    "Volcanic breccia or agglomerate", "Zeolitic rock",
                    ...
                    "Porphyritic rock (2nd option)", "Vitrophyre", "Quartz",
                    "Ore" };
    ...
    public String imagePath() {
        System.out.println("returns " + imagePath);
        return imagePath;
    }
