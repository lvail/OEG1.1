...
public class Login extends JDialog implements ActionListener {
    ...
    // private final JPanel contentPanel = new JPanel(); // might need to be
    // removed
    ...
    boolean id = false; // debuging code -_-
     ...
     *            is the client
     */
    public Login(Frame logInFrame, final ClientFrame callback) {
        super(logInFrame, "Login", true);
