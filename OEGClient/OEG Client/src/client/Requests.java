...
public class Requests extends JFrame {
    ...
    private JLabel oilTextArea, gasTextArea, layerTextArea, rockTypeTextArea,
                    mapPane;
    ...
    static {
        try {
            ...
            // handle exception
            System.out.println("Error UIManager.setLookAndFeel did not work");
        }
    }
    ...
    public Requests() {
        ...
        mainPanel.setBounds(0, 0, 853, 598);
        ...
        topInfoL(mainPanel);
        topInfoR(mainPanel);
        bottomInfo(mainPanel);
        mapPanel(mainPanel);
        sliceView(mainPanel);
        actionPanel(mainPanel);
        queuePanel(mainPanel);
        cellInfoPanel(mainPanel);
        messagePanel(mainPanel);
    ...
    /**
     * Create the top info panel, including team name label and bank amount
     * labels
     * 
     * @param panel
     *            The panel that this info panel should be added to.
     */
    ...
    /**
     * Create the top right info panel, including timer label and round number
     * info.
     * 
     * @param panel
     *            The panel that this info panel should be added to.
    ...
    /**
     * Create the bottom info panel, including the Connected To label and the
    ...
    /**
     * Create the map panel, where the Map grid is placed. When scrollbars are
     * enabled: unblock mapPane here and in constructMap. When scrollbars are
     * disabled: to re-enable, unblock comments here and constructMap, and block
     * out mapPane below.
     * 
     * @param panel
     *            The panel that this map panel should be added to.
     */
    private void mapPanel(JPanel panel) {
        mapScrollPane.setBounds(10, 31, 500, 500);
        panel.add(mapScrollPane);
        mapScrollPane.setHorizontalScrollBarPolicy(
                        ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        mapScrollPane.setVerticalScrollBarPolicy(
         ...
         * panel.add(mapPane); mapPane.setBorder(new
         * EtchedBorder(EtchedBorder.LOWERED, null, null));
         * mapPane.setBackground(Color.BLACK); mapPane.setOpaque(true);
         */
    }
    ...
    /**
     * Create the action panel, where the all the action fields and buttons are
     * placed.
     * 
     * @param panel
     *            The panel that this action panel should be added to.
     */
    private void actionPanel(JPanel panel) {
        ...
        seismicCostField.setBorder(new BevelBorder(BevelBorder.LOWERED, null,
                        null, null, null));
        ...
        SLButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                map.curBGColor = new Color(82, 61, 0);
            }
        });
        ...
        requestButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    if (operator.makeNewSeismicRequest(x1Value, y1Value,
                                    x2Value, y2Value)) {
        ...
        /*
         * crossButton.addActionListener(new ActionListener() { public void
         * actionPerformed(ActionEvent arg0) { try { int x1Value =
         * Integer.parseInt(x1Field.getText()); int y1Value =
         * Integer.parseInt(y1Field.getText()); int x2Value =
         * Integer.parseInt(x2Field.getText()); int y2Value =
         * Integer.parseInt(y2Field.getText()); if
         * (operator.makeNewSeismicRequest(x1Value, y1Value, x2Value, y2Value))
         * { addMessage("Valid. Seismic Data Request Made.");
         * seismicCostField.setText(""); } else { addMessage(
         * "Problem with request. Verify valid coordinates and enough funds.");
         * } x1Field.setText(""); y1Field.setText(""); x2Field.setText("");
         * y2Field.setText(""); } catch (NumberFormatException nfe) {
         * addMessage("Problem with request. Please select a cell."); } } });
         */
     ...
     * 
     * @param panel
     *            The panel that this action queue panel should be added to.
     */
    ...
    /**
     * Create the message panel, where messages to the server are placed, inside
     * a scrollbar.
     * 
     * @param panel
     *            The panel that this info panel should be added to.
     ...
     * 
     * @param m
     *            Indicates which color the countdown should be set to.
     */
     ...
     * @param oil
     *            The oil content of the cell.
     * @param gas
     *            The gas content of the cell.
     * @param layers
     *            The layer elevations of the cell.
     * @param rocktype
     *            The rocktype of the cell.
     */
    public void setCellInfo(String owner, String oil, String gas, String layers,
                    String rocktype) {
    ...
    /**
     * Create the Map grid of size p and set the state of the GUI to start as
     * normal.
     * 
     * @param p
     *            The grid size represented in a Point.
     */
    ...
    /**
     * Add a message to the message box JList, and make sure the new message is
    ...
    /**
     * Refresh the UI, including repainting the graphics and reload the Cell
    ...
    /**
     * Disable the action buttons so that new actions are not able to be
     * performed.
     */
