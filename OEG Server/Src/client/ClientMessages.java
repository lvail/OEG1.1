...
public class ClientMessages extends Messages {
    ...
    /**
     * The Applet interface that is used to update based on information that is
     * received.
     */
     ...
     * ClientApplet class that will receive incoming data.
     * 
     * @param applet
     *            Applet that displays information on the GUI
     * @param sock
    ...
    public void parse(String in, Prefix pr) {
        ...
        switch (pr) {
            ...
            case SERVER:
                ...
                break;
            case WARNING:
                JOptionPane.showMessageDialog(applet.GUI, in, "Server Message",
                                JOptionPane.ERROR_MESSAGE);
